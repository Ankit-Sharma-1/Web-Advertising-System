...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q12.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Information about revenue at Ad grain.</p>
   
    <br>
    <p><b>SQL Query</b></p>
    <p><i>CREATE VIEW ad_sum_revenue(Total_Cost) AS(</p>
    ...
    <p>GROUP BY clicks.AdID)</p>
    <br>
    <p>SELECT $aggregate(Total_Cost)</p>
    <p>FROM ad_sum_revenue</i></p>
    <br>
    <?php 

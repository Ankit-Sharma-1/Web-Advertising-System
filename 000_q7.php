...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q7.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Gender distribution of people(members) likely to click on the ads.</p>
    <br>
    <p><b>SQL Query</b></p>
    <p><i>SELECT Gender, COUNT(Gender)</p>
    ...
    <table class="table">
      <thead>
            <tr>
                ...
                <th scope="col">Count of users</th>
            </tr>
        </thead>
      <tbody id="studentTable">
        ...
        $query = "SELECT Gender, COUNT(Gender) FROM member GROUP BY Gender";
        $result = mysqli_query($conn, $query);
        // put all our results into a html table
        while ($rows = mysqli_fetch_array($result)) {
            echo "<tr>";
            echo "<td>".$rows["Gender"]."</td>";
            echo "<td>".$rows["COUNT(Gender)"]."</td>";
            echo "</tr>";
          }
        }
            ?>

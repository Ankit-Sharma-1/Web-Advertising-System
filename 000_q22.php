...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q22.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Delete Website partner after contract completion</p>

    <h3>Website Partner (Previous Week)</h3>
        <table class=  table><thead><tr><th>URL</th></tr></thead>
            <tbody>
                <tr>
                    <td>http://www.amazon.au</td>
                </tr>
                <tr>
                    <td>http://www.coles.au</td>
                </tr>
                <tr>
                    <td>http://www.microsoft.au</td>
                </tr>
                <tr>
                    <td>http://www.uber.au</td>
                </tr>
                <tr><td>http://www.uq.au</td>
                </tr>
                <tr>
                    <td>http://www.uqunion.au</td>
                </tr>
            </tbody>
        </table>
    ...
    <form action="" method="post">
        <br>
        <p>Enter URL of website partner to be removed</p>

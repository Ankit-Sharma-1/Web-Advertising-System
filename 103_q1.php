...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/103_q1.php">Current Query</a>
</div>
...
<div class="row">
  <div class="main"
    ...
    <br>
    <p><b>SQL Query</b></p>
    <p><i>SELECT * FROM ad WHERE AdvertiserID = 103</i></p>
    <br>
    ...
    <table class="table">
      ...
      <tbody id="studentTable">
        ...
        $query = "SELECT * FROM ad WHERE AdvertiserID = 103";

...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q14.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Information about CPC at Advertiser grain.</p>
   
    <br>
    <p><b>SQL Query</b></p>
    <p><i>CREATE VIEW advertiser_cpc(CPC) AS(</p>
    <p>SELECT ROUND(SUM(SlotClickCost)/COUNT(ClickID),2) AS CPC </p>
    ...
    <br>
    <p>SELECT $aggregate(CPC)</p>
    <p>FROM advertiser_cpc</i></p>
    <br>
    <?php 
    ...
    <table class="table">
      <thead>
            <tr>
                <th scope="col">Aggregated CPC ($)</th>
            </tr>
        </thead>
      <tbody id="Table">
        <?php
        ...
        // get data
        $query = "SELECT $aggregate(CPC) 
            FROM advertiser_cpc";
        $result = mysqli_query($conn, $query);
        // put all our results into a html table
        while ($rows = mysqli_fetch_array($result)) {
            echo "<tr>";
            echo "<td>".$rows["$aggregate(CPC)"]."</td>";
            echo "</tr>";
          }
        }
            ?>

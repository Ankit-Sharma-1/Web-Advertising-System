...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q13.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Information about revenue at Advertiser grain.</p>
   
    <br>
    <p><b>SQL Query</b></p>
    <p><i>CREATE VIEW advertiser_sum_revenue(Total_Cost) AS(</p>
    <p>SELECT ROUND(SUM(SlotClickCost),2) AS Total_Cost</p>
    ...
    <br>
    <p>SELECT $aggregate(Total_Cost)</p>
    <p>FROM advertiser_sum_revenue</i></p>
    <br>
    <?php 
    ...
    <table class="table">
      <thead>
            <tr>
                <th scope="col">Aggregated Revenue ($)</th>
            </tr>
        </thead>
      <tbody id="Table">
        <?php
        ...
        // get data
        $query = "SELECT $aggregate(Total_Cost) 
            FROM advertiser_sum_revenue";
        $result = mysqli_query($conn, $query);
        // put all our results into a html table
        while ($rows = mysqli_fetch_array($result)) {
            echo "<tr>";
            echo "<td>".$rows["$aggregate(Total_Cost)"]."</td>";
            echo "</tr>";
          }
        }
            ?>

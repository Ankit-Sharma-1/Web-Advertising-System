...
<div class="navbar">
    ...
    <a href="https://s4515529-infs7901.uqcloud.net/106.php">Queries</a>
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/106_q2.php">Current Query</a>
</div>
...
<div class="row">
  <div class="main"
    ...
    <p>WHERE WHERE clicks.AdvertiserID = 106 AND Age is NOT NULL AND Gender is NOT NULL</i></p>
    <br>
    ...
    <table class="table">
      ...
      <tbody id="studentTable">
        ...
        $query = "SELECT clicks.AdID, member.Age, member.Gender FROM clicks LEFT OUTER JOIN member ON clicks.SessionID = member.SessionID WHERE clicks.AdvertiserID = 106 AND Age is NOT NULL AND Gender is NOT NULL";

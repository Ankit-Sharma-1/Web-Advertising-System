...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q6.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Get a list of Advertiser's bidding on all slots</p>
    <br>
    <p><b>SQL Query</b></p>
    <p><i>SELECT AdvertiserID </p>
    <p>FROM advertiser </p>
    <p>WHERE NOT EXISTS</p>
    <p>&nbsp&nbsp(SELECT webpage.SlotID</p>
    <p>&nbsp&nbspFROM webpage </p>    
    <p>&nbsp&nbspWHERE NOT EXISTS</p>
    <p>&nbsp&nbsp&nbsp&nbsp(SELECT ad.SlotID</p>
    <p>&nbsp&nbsp&nbsp&nbspFROM ad</p>
    <p>&nbsp&nbsp&nbsp&nbspWHERE ad.SlotID = webpage.SlotID</p>
    <p>&nbsp&nbsp&nbsp&nbspAND ad.AdvertiserID = advertiser.AdvertiserID))</i></p>
    <br>
    <?php 
    ...
    <table class="table">
      ...
      <tbody id="Table">
        ...
        // get data
        $query = "SELECT AdvertiserID 
                    FROM advertiser 
                    WHERE NOT EXISTS
                        (SELECT webpage.SlotID
                        FROM webpage 
                        WHERE NOT EXISTS
                            (SELECT ad.SlotID
                            FROM ad
                            WHERE ad.SlotID = webpage.SlotID
                            AND ad.AdvertiserID = advertiser.AdvertiserID))";

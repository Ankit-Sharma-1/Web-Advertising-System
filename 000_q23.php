...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q23.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>View previous website partners</p>
    <br>
    <p><b>SQL Query</b></p>
    <p><i>SELECT * FROM website_old</i></p>
    <br>

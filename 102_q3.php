...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/102_q3.php">Current Query</a>
</div>
...
<div class="row">
  <div class="main"
    ...
    <p>WHERE Date >= '$start_date' AND Date <= '$end_date' AND clicks.AdvertiserID = 102</p>
    ...
    <table class="table">
      ...
      <tbody id="Table">
        ...
        $query = "SELECT COUNT(ClickID), 
            ...
            WHERE Date >= '$start_date' AND Date <= '$end_date' AND clicks.AdvertiserID = 102

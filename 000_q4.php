...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q4.php">Current Query</a>
</div>
...
<div class="row">
  <div class="main"
    ...
    <br>
    <p><b>SQL Query</b></p>
    <p><i>SELECT clicks.AdvertiserID, COUNT(ClickID),</p>
    ...
    <table class="table">
      ...
      <tbody id="Table">
        ...
        // get data
        $query = "SELECT clicks.AdvertiserID, COUNT(ClickID), 

...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q9.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Distribution of age, clicks and revenue in ad space.</p>
    <br>
    <p><b>SQL Query</b></p>
    <p><i>SELECT ad.SlotID, AVG(Age), COUNT(ClickID),</p>
    <p>ROUND(SUM(SlotClickCost),2)</p>
    <p>FROM clicks LEFT OUTER JOIN ad</p>
    <p>ON clicks.AdID = ad.AdID</p>
    <p>LEFT OUTER JOIN webpage </p>
    <p>ON ad.SlotID = webpage.SlotID</p>
    <p>LEFT OUTER JOIN member</p>
    <p>ON clicks.SessionID = member. SessionID</p>
    <p>GROUP BY ad. SlotID</i></p>
    <br>

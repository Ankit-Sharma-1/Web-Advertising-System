...
<div class="navbar">
    ...
    <a class="active" href="https://s4515529-infs7901.uqcloud.net/000_q8.php">Current Query</a>
</div>

<div class="row">
  <div class="main"
    <p>Age distribution of people(members) by gender likely to click on the ads.</p>
    
    <br>
    <p><b>SQL Query</b></p>
    <p><i>SELECT Gender, $aggregate(Age) </p>
    <p>FROM member</p>
    <p>GROUP BY Gender</i></p>
    <br>
    <?php 
    ...
    <table class="table">
      <thead>
            <tr>
                ...
                <th scope="col">Aggregated Age</th>
            </tr>
        </thead>
      <tbody id="Table">
        <?php
        ...
        // get data
        $query = "SELECT Gender, $aggregate(Age) 
            FROM member
            GROUP BY Gender";
